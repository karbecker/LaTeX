% Preamble
% Karl Becker, Stand: 28.10.16
% -------------------
\documentclass[12pt,a4paper,oneside,toc=indentunnumbered]{article}
% -------------------
% Seitenränder
\usepackage{geometry}
\geometry{includeheadfoot, left=30mm, right=35mm, top=15mm, bottom=10mm, footnotesep=7.5mm, headsep=7.5mm}
% -------------------
% Inhaltsverzeichnis
% -------------------
...
% -------------------
% Für Definitionslisten nach dem Schema 
% \begin{labeling}{längsteswort}
% \item [Wort] Beschreibung
