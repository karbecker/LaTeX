...
\lstset{style=mystyle, breaklines=true, numbers=left, numberstyle={\scriptsize\ttfamily\color{gray!50}}, columns=fullflexible, backgroundcolor=\color{gray!10}}
...
\usepackage[backend=bibtex,style=verbose-ibid,citepages=omit]{biblatex}
% ibid etc. kursiv
